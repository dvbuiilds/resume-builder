...
export async function POST(req: NextRequest) {
  try {
    ...
    let result: unknown;
    if (inlineMock) {
      console.log('@@ Dhairya string generated via Mock String');
      result = inlineMock;
    } else if (process.env.MOCK_GROQ_RESPONSE) {
      console.log('@@ Dhairya string generated via Constant String');
      result =
      ...
      console.log('@@ Dhairya string generated via API');
